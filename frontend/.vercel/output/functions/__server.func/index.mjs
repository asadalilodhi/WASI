...
import { i as proxyRequest, n as HTTPError, o as NodeResponse, r as defineLazyEventHandler, t as H3Core } from "./_libs/h3+rou3+srvx.mjs";
...
var findRouteRules = /* @__PURE__ */ (() => {
	const $0 = [{
		...
		handler: proxy,
		options: {
			"to": "https://irregular-jailbreak-contort.ngrok-free.dev/api/**",
			"_proxyStripBase": "/api"
		}
	}], $1 = [{
		name: "headers",
...
var _lazy_nlP46i = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_nlP46i
	};
	return ((_m, p) => {
		return {
			data,
